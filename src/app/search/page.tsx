...
import { IServiceDetail } from "@/types/database";
        ...
        <div className="space-y-6">
          ...
          {results.map((result, index) => {
            const technicianNames =
              result.service.technicians &&
              result.service.technicians.length > 0
                ? allTechnicians
                    .filter((t) =>
                      result.service.technicians?.includes(String(t.id)),
                    )
                    .map((t) => t.name)
                    .join(", ")
                        ...
                        <div className="space-y-3">
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="font-medium">{technicianNames}</p>
                            </div>
                          </div>
                          <div className="flex items-start gap-3">
